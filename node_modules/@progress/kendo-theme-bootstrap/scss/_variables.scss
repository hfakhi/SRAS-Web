...
$form-line-height: $btn-line-height !default;
...
$accent-contrast: $component-active-color !default;
...
$base-text: $btn-secondary-color !default;
/// The background of the components' chrome area.
$base-bg: $btn-secondary-bg !default;
/// The border color of the components' chrome area.
$base-border: darken( $base-bg, 12% ) !default;
...
$invalid-border-color: $error !default;
...
$header-border: $card-border-color !default;
...
/// @group buttons
$button-border: darken( $base-border, 8 ) !default;
...
/// @group buttons
$button-hovered-bg: darken( $button-bg, 10% ) !default;

/// The border color of hovered buttons.
/// @group buttons
$button-hovered-border: darken( $button-border, 12% ) !default;
...
/// @group buttons
$button-pressed-text: $button-hovered-text !default;

/// The background color of pressed buttons.
/// @group buttons
$button-pressed-bg: $button-hovered-bg !default;

/// The border color of pressed buttons.
/// @group buttons
$button-pressed-border: $button-hovered-border !default;
...
/// @group buttons
$button-focused-shadow: 0 0 0 2px rgba($button-border, .5) !default;


// Primary button
$primary-button-text: $btn-primary-color !default;
$primary-button-bg: $btn-primary-bg !default;
$primary-button-border: $btn-primary-border !default;
$primary-button-gradient: none !default;

$primary-button-hovered-text: $primary-button-text !default;
$primary-button-hovered-bg: darken( $primary-button-bg, 10% ) !default;
$primary-button-hovered-border: darken( $primary-button-border, 12% ) !default;
...
$primary-button-focused-shadow: 0 0 0 2px rgba($primary-button-border, .5);
...
$node-hovered-text: $button-hovered-text !default;
$node-hovered-bg: $button-hovered-bg !default;
$node-hovered-border: $button-hovered-border !default;
...
$tab-item-selected-text: $nav-tabs-active-link-color !default;
$tab-item-selected-bg: $nav-tabs-active-link-bg !default;
$tab-item-selected-border: $nav-tabs-active-link-border-color !default;


// Grid
$grid-text: inherit !default;
$grid-bg: $table-bg !default;
$grid-border: $table-border-color !default;

$grid-alt-text: $grid-text !default;
$grid-alt-bg: $table-bg-accent !default;
$grid-alt-border: $grid-border;

$grid-hovered-text: $grid-text !default;
$grid-hovered-bg: $table-bg-hover !default;
...
$notification-error-bg: theme-color-level($error, -10) !default;
$notification-error-text: theme-color-level($error, 6) !default;
$notification-error-border: theme-color-level($error, -9) !default;
