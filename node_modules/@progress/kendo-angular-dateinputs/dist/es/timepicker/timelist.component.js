...
import { Component, ChangeDetectionStrategy, EventEmitter, ElementRef, HostBinding, HostListener, ViewChild, Injector, Input, Output } from '@angular/core';
 ...
 * @hidden
 */
var TimeListComponent = (function () {
    function TimeListComponent(element, injector, dom) {
     ...
     * @hidden
     */
    TimeListComponent.prototype.mouseover = function () {
        if (this.isActive) {
            return;
        }
        this.focus();
    ...
    TimeListComponent.prototype.ngOnInit = function () {
        ...
        this.style = { transform: "translateY(" + this.topOffset + "px)" };
        this.scrollSubscription = this.virtualization
            .scroll$()
            .debounceTime(50)
            .map(function (e) { return e.target.scrollTop; })
            .map(function (top) { return _this.itemOffset(top); })
            .map(function (itemOffset) { return _this.virtualization.itemIndex(itemOffset); })
