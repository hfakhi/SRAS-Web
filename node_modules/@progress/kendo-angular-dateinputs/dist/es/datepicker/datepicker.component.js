...
import { Component, EventEmitter, HostBinding, HostListener, Input, Output, ContentChild, ViewChild, ViewContainerRef, NgZone, Inject, Optional, forwardRef, isDevMode } from '@angular/core';
        ...
        if (this._show) {
            ...
            this.popupRef.popupOpen.subscribe(function () {
                if (_this.isActive && _this.calendar) {
                    _this.resolvedPromise.then(function () { _this.calendar.focus(); });
                }
            });
