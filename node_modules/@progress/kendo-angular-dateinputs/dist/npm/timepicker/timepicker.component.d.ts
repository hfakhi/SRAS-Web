import { ChangeDetectorRef, ElementRef, EventEmitter, NgZone, TemplateRef, ViewContainerRef, QueryList, OnInit, OnChanges, OnDestroy } from '@angular/core';
 ...
 */
export declare class TimePickerComponent implements ControlValueAccessor, OnChanges, OnDestroy, OnInit {
    zone: NgZone;
    dom: DOMService;
    ...
    constructor(zone: NgZone, dom: DOMService, localization: LocalizationService, cdr: ChangeDetectorRef, intl: IntlService, popupService: PopupService, rtl: boolean);
    /**
     * @hidden
     */
    ngOnInit(): void;
