 ...
 * @hidden
 */
exports.SCROLLER_FACTORY_TOKEN = new core_1.OpaqueToken('dateinputs-scroll-service-factory');
/**
 * @hidden
 */
...
var VirtualizationComponent = (function () {
    ...
    VirtualizationComponent.prototype.animateToIndex = function (index) {
        ...
        var animationFrame$ = Observable_1.Observable.interval(0, animationFrame_1.animationFrame);
    ...
    VirtualizationComponent.prototype.scrollRange = function (indexOffset, direction) {
        ...
        var difference = differenceToScroll(containerElement.scrollTop, indexOffset, this.maxScrollDifference);
