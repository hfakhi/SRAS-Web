...
.k-scheduler-navigation .k-nav-next, .k-scheduler-views li, .k-scheduler-footer li {
  ...
  background-color: #2f4050;
  border-color: rgba(0, 0, 0, 0.08);
  background-image: linear-gradient(#2f4050, #2b3b4a); }
...
.k-scheduler-navigation .k-nav-next.k-state-hover, .k-scheduler-views li.k-state-hover, .k-scheduler-footer li.k-state-hover {
  ...
  background-image: linear-gradient(#2eb3a6, #2cab9e); }
...
.k-button.k-primary, .k-slider .k-draghandle, .k-switch-on .k-switch-handle {
  ...
  border-color: #10c4b2;
  background-image: linear-gradient(rgba(16, 172, 196, 0), rgba(16, 172, 196, 0.2)); }
...
.k-dialog-buttongroup .k-button.k-primary.k-state-active, .k-slider .k-draghandle:active, .k-slider .k-draghandle.k-pressed {
  ...
  background-color: #10c4b2;
  border-color: #10c4b2;
  background-image: linear-gradient(rgba(16, 172, 196, 0.2), rgba(16, 172, 196, 0)); }
...
.k-spreadsheet-selection {
  border-color: #10c4b2;
  background-color: rgba(16, 196, 178, 0.25);
  box-shadow: inset 0 0 0 1px #ffffff, 0 0 0 1px #10c4b2; }
...
.k-fieldselector .k-list li.k-item {
  ...
  .k-fieldselector .k-list li.k-item.k-state-active {
    ...
    color: #ffffff;
    background-color: #2f4050;
    background-image: linear-gradient(to top, #2f4050, #2b3b4a);
    box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.06); }
...
.k-radio:checked + .k-radio-label::before {
  background-color: #10c4b2;
  border-color: transparent;
  box-shadow: 0 0 1px 0 #10c4b2 inset; }
...
.k-radio:focus:checked + .k-radio-label::before {
  box-shadow: 0 0 0 2px rgba(16, 196, 178, 0.3);
  border-color: #10c4b2; }
...
.k-mediaplayer-toolbar {
  background-color: rgba(47, 64, 80, 0.85); }
