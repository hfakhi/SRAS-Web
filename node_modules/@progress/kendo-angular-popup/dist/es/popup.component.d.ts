...
export declare class PopupComponent implements AfterViewChecked, OnInit, OnChanges, OnDestroy {
    ...
    constructor(container: ElementRef, _alignService: AlignService, _domService: DOMService, _cdr: ChangeDetectorRef, _positionService: PositionService, _resizeService: ResizeService, _scrollableService: ScrollableService, _renderer: Renderer2);
    ngOnInit(): void;
